...
public plugin_natives()
{
	...
	register_native( "zpv_human_speed_set", "_set_speed" );
	register_native( "zpv_human_speed_reset", "_reset_speed" );
	register_native( "zpv_human_speed_get", "_get_speed" );

	register_native( "zpv_human_gravity_set", "_set_gravity" );
	register_native( "zpv_human_gravity_reset", "_reset_gravity" );
	register_native( "zpv_human_gravity_get", "_get_gravity" );
...
public _set_speed( pl, argc )
{
	...
	if( !zp_core_is_zombie(id) )
		cs_set_player_maxspeed_auto(id, (Float:ArrayGetCell(g_HumanClassSpeed, g_HumanClass[id])+fSpeedNative[id]) )
}
...
public _set_gravity( pl, argc )
{
	...
	if( !zp_core_is_zombie( id ) )
		set_user_gravity(id, (Float:ArrayGetCell(g_HumanClassGravity, g_HumanClass[id])+fGravityNative[id]) )
}
